...
<div style="position:absolute;bottom:0px;right:5px;background-color: #f88b95;"><table><tr><td onclick="javascript:parent.location.href='index.php'" class=headhref >首頁</td><td onclick="menu()" class=headhref id=headmenuclick>資料</td><td onclick="javascript:parent.location.href='about.php'" class=headhighlight>關於我們</td></tr></table>
</div></div><br>
...
<table border="0" cellpadding="0" cellspacing="0" width=100% height=90%>
        <tr>
          <td valign="top" style="padding-left:10px;"><p class=subtitle>制作單位<br><br><img src="images/pooito_logo.png" height="53"></p>
            <p class=subtitle>制作人員:</p>
            
			<span class=subsubtitle>網頁制作</span><br>
			<span class=person>湯穎豪</span><br>  
			<span class=person>梁永健</span><br>
			<span class=subsubtitle>影片拍攝與後期制作</span><br>
            <span class=person>呂聞西</span><br>
            <span class=person>陳曦朗</span><br>
			<span class=person>湯穎豪</span><br> 
		    <span class=subsubtitle>資料搜集</span><br>
		    <span class=person>蔡鎮偉</span><br>
		    <span class=person>湯穎豪</span><br> 
		    <span class=subsubtitle>網頁美化與美工</span><br>
		    <span class=person>陳曦朗</span><br>
        <p class=subtitle>鳴謝:</p>  
		  <span class=person>澳門兒童之家</span><br>
		    <span class=person>培道中學</span><br>
		  <span class=person>培道中學義工小組</span><br>
           </td>
     
          <td><img src="images/DSC_4727.jpg" width="414" height="278"></td>
		  <td><img src="images/member.jpg" width="414" ></td>
        </tr>
      </table>
