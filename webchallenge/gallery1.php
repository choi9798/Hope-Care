...
break;
case 'pic2zoom':
document.getElementById('detail001').style.display='block';
break;
case 'pic3zoom':
document.getElementById('detail002').style.display='block';
break;
case 'pic4zoom':
document.getElementById('detail003').style.display='block';
break;
case 'pic5zoom':
document.getElementById('detail004').style.display='block';
break;
case 'pic6zoom':
document.getElementById('detail005').style.display='block';
break;
case 'pic7zoom':
document.getElementById('detail006').style.display='block';
break;
case 'pic8zoom':
document.getElementById('detail007').style.display='block';
break;
case 'pic9zoom':
document.getElementById('detail008').style.display='block';
break;
case 'pic10zoom':
document.getElementById('detail009').style.display='block';
break;
case 'pic11zoom':
document.getElementById('detail010').style.display='block';
break;
}
}
...
<div style="position:absolute;bottom:0px;right:5px;"><table><tr><td onclick="javascript:parent.location.href='index.php'" class=headhref >首頁</td><td onclick="menu()" class=headhref id=headmenuclick>資料</td><td onclick="javascript:parent.location.href='about.php'" class=headhref>關於我們</td></tr></table>
</div></div><br>
...
<div class=title>圖片集</div>
<center>
<table width=98% height=80% cellpadding=5px style="padding-top:10px;">
<tr>
<td  align=center style="position:relative;">

<img src=activity/DSC_4553.jpg      style=" position:absolute;top:0px;left:0px;z-index:2" width=100% id=pic1 class=smallpic onMouseOver="pichover(event)"><div class=pichover style="z-index:1"  onmouseout="picmouseout()"><div style="border:solid 1px;width:65px;height:25px;position:absolute;top:65%;left:31%;background-color:#050512;color:white;font-size:15px;cursor:pointer;opacity:1;" onclick="piczoominshow('pic1')" >Button</div></div>
</td>
<td  align=center>
...
<br>
<div id=footer class=box style="height:100px;width:100%;z-index:1;">
<table width=100% height=100%>
<tr>
<td valign=top>
<a href="index.php" class=foothref>首頁</a>
...
<div style="overflow:hidden;  position:absolute;top:0px;left:0px;width:100%;height:100%">
...
<div id="detail" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(0)">
</div>
...
<div id="detail001" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(1)">
</div>
...
<div id="detail002" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(2)">
</div>
...
<div id="detail003" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(3)">
</div>
...
<div id="detail004" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(4)">
</div>
...
<div id="detail005" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;"onclick="detaildisplay(5)">
</div>
...
<div id="detail006" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(6)">
</div>
...
<div id="detail007" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(7)">
</div>
...
<div id="detail008" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(8)">
</div>
...
<div id="detail009" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(9)">
</div>
...
<div id="detail010" style="min-width:400px;min-height:400px;background-color:black;opacity:0.7;padding:16px;position:absolute;top:10%;left:85%;z-index:123;display:none;" onclick="detaildisplay(10)">
</div>
</div>
