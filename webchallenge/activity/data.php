...
<div style="position:absolute;bottom:0px;right:5px;"><table><tr><td onclick="javascript:parent.location.href='index.php'" class=headhref >首頁</td><td onclick="menu()" class=headhighlight id=headmenuclick>資料</td><td onclick="javascript:parent.location.href='about.php'" class=headhref >關於我們</td></tr></table>
</div></div><br>
<div id=main>
...
$aa = $dbha ->prepare("UPDATE  `data` SET  `search` = :search WHERE  `data`.`id` =:id;");
